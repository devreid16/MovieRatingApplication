    ...
    public partial class Product1 : System.Web.UI.Page
    {
       public Order myOrder;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //we need one parameter for each product, since this page only displays one product we can hard code the 1 product
            //by sending only one product id as our only parameter

            SqlParameter productIDParameter = new SqlParameter();
            productIDParameter.ParameterName = "@ProductID";
            productIDParameter.Value = 1;
